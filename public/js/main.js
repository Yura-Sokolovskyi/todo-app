...
var TODO_LIST_ID_ATTRIBUTE = 'data-todo-list-id';
var GET_TODOS_URL_PATTERN = '/todos/';
var TODO_STATUS_ICO = '<i class="bi-square"></i>';
var TODO_STATUS_ICO_DONE = '<i class="bi bi-check-square-fill todo-done-ico"></i>';
var NO_TODO_LIST_TEMPLATE = document.getElementsByClassName('no-todo-list')[0];
var TODOS_CONTAINER = document.getElementsByClassName('todos-container')[0];
var TODOS_LIST_BTN_CONTAINER = document.getElementsByClassName('todo-list-nav')[0];
var ADD_TODO_BTN = document.getElementById('addTodoBtn');
var ADD_TODO_TITLE_INPUT = document.getElementById('addTodoTitle');
var ADD_TODO_LIST_BTN = document.getElementById('addTodoListBtn');
var ADD_TODO_LIST_BTN_1 = document.getElementById('createTodoList1');
var todoListBtns = document.getElementsByClassName('todolist-nav-btn');

for (var _i = 0, _arr = [ADD_TODO_LIST_BTN, ADD_TODO_LIST_BTN_1]; _i < _arr.length; _i++) {
  var addBtn = _arr[_i];
  addBtn.addEventListener('click', function () {
    clearTodosContainer();
    var todoListBtn = document.createElement('li');
    var todoListNameInput = document.createElement('input');
    ...
    todoListNameInput.addEventListener('focusout', function () {
      var data = {
        name: todoListNameInput.value
      };

      if (todoListNameInput.value.trim().length > 0) {
        addTodoList(data).then(function (data) {
...
var _iterator = _createForOfIteratorHelper(todoListBtns),
    _step;

try {
  var _loop = function _loop() {
    var btn = _step.value;
    var todoListId = btn.getAttribute(TODO_LIST_ID_ATTRIBUTE);
...
function createRemoveBtn(id) {
  var todoListRemoveBtn = document.createElement('div');
  ...
  todoListRemoveBtn.addEventListener('click', function () {
    deleteTodoList(id).then(function (data) {
      if (data.status === 200) {
        var selector = "li[data-todo-list-id='".concat(id, "']");
        var navBtns = document.getElementsByClassName('todolist-nav-btn');
...
function todoListRemoveActive() {
  var _iterator2 = _createForOfIteratorHelper(todoListBtns),
      _step2;
...
ADD_TODO_BTN.addEventListener('click', function () {
  var todoTitle = ADD_TODO_TITLE_INPUT.value;
  var data = {
    title: todoTitle,
  ...
  if (todoTitle.trim().length >= 3) {
    addTodo(data).then(function (todo) {
...
function buildTodoList(id) {
  clearTodosContainer();
  getTodos(id).then(function (todos) {
    for (var _i2 = 0, _Object$values = Object.values(todos); _i2 < _Object$values.length; _i2++) {
      var todo = _Object$values[_i2];
...
function addTodoToList(id, title) {
  ...
  var todoBtnGroup = document.createElement("div");
  var todoFinishedBtn = document.createElement("button");
  var todoEditBtn = document.createElement("button");
  var todoRemoveBtn = document.createElement("button");
  todo.draggable = true;
  todo.addEventListener('dragstart', function (evt) {
    evt.target.classList.add("selected");
  });
  todo.addEventListener('dragend', function (evt) {
    evt.target.classList.remove("selected");
    var todosOrder = [];
    var data = {};
    var todoItems = TODOS_CONTAINER.getElementsByClassName('todo-item');
    ...
    updateTodoPosition(data).then(function (resp) {});
  });
  ...
  todo.addEventListener("dragover", function (evt) {
    evt.preventDefault();
    var activeElement = TODOS_CONTAINER.querySelector(".selected");
    var currentElement = evt.target;
    var isMoveable = activeElement !== currentElement && currentElement.classList.contains("todo-item");
  ...
  todoFinishedBtn.addEventListener('click', function () {
    todoDoneSwitcher(id);
  });
  ...
  todoEditBtn.addEventListener('click', function () {
    var todoTitleInput = document.getElementById(id).getElementsByClassName('todo-item-title')[0];
    ...
    todoTitleInput.addEventListener('focusout', function () {
      ...
      updateTodo(id, data).then(function (data) {
        if (data.status === 200) {}
      });
    });
  });
  ...
  todo.id = id;
  var statusIco = isDone ? TODO_STATUS_ICO_DONE : TODO_STATUS_ICO;
  var statusInputClass = isDone ? 'done' : '';
  todo.innerHTML = "<div class=\"todo-item-left-side d-flex\">\n\n                            <div class=\"todo-item-status d-flex  justify-content-center align-items-center\">\n                               ".concat(statusIco, "\n                            </div>\n\n                            <input class=\"todo-item-title ").concat(statusInputClass, "\" type=\"text\" value=\"").concat(title, "\" disabled>\n\n                        </div>");
  todo.append(todoBtnGroup);
  TODOS_CONTAINER.append(todo);
}

function todoDoneSwitcher(id) {
  var todoTitle = document.getElementById(id).getElementsByClassName('todo-item-title')[0];
  var todoStatusIco = document.getElementById(id).getElementsByClassName('todo-item-status')[0];
  var isDone = todoTitle.classList.contains('done');
  var data = {
...
function clearTodosContainer() {
  ...
  var _iterator3 = _createForOfIteratorHelper(todos),
      _step3;
...
function addTodoList(_x) {
  return _addTodoList.apply(this, arguments);
}

function _addTodoList() {
  _addTodoList = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(data) {
    var response;
...
function _deleteTodoList() {
  _deleteTodoList = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(id) {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch('/todo-list/' + id, {
              method: 'DELETE',
              headers: {
                "X-CSRF-Token": TOKEN
              },
...
function getTodos(_x3) {
  return _getTodos.apply(this, arguments);
}

function _getTodos() {
  _getTodos = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(id) {
    var url, response;
...
function _addTodo() {
  _addTodo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4(data) {
    var response;
...
function _deleteTodo() {
  _deleteTodo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5(id) {
...
function _updateTodo() {
  _updateTodo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee6(id, data) {
...
function updateTodoPosition(_x8) {
  return _updateTodoPosition.apply(this, arguments);
}

function _updateTodoPosition() {
  _updateTodoPosition = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee7(data) {
